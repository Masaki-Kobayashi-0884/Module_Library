...
void LSM_9DS1::FIFOInit(){
	...
	I2cWriteByte(LSM9DS1_AG, CTRL_REG9, tempRegValue);
	...
	I2cWriteByte(LSM9DS1_AG, FIFO_CTRL, tempRegValue);
}
...
void LSM_9DS1::FiltersInit()
{
	...
	I2cWriteByte(LSM9DS1_AG, REFERENCE_G, 0x00);
	...
	I2cWriteByte(LSM9DS1_AG, CTRL_REG3_G, tempRegValue);
	...
	tempRegValue = I2cReadByte(LSM9DS1_AG, CTRL_REG6_XL);
	tempRegValue &= 0b11111000;
	tempRegValue |= (0b000 & 0x07);
	I2cWriteByte(LSM9DS1_AG, CTRL_REG6_XL, tempRegValue);
	...
	tempRegValue |= 0b100;
	I2cWriteByte(LSM9DS1_AG, CTRL_REG7_XL, tempRegValue);
}
...
void LSM_9DS1::AccInit(int scale)
{
	...
	I2cWriteByte(LSM9DS1_AG, CTRL_REG5_XL, 0b111000);
...
void LSM_9DS1::GyrInit(int scale)
{
	...
	I2cWriteByte(LSM9DS1_AG, CTRL_REG1_G, tempRegValue);

	// CTRL_REG2_G (Default value: 0x00)
	// [0][0][0][0][INT_SEL1][INT_SEL0][OUT_SEL1][OUT_SEL0]
	// INT_SEL[1:0] - INT selection configuration
	// OUT_SEL[1:0] - Out selection configuration
	I2cWriteByte(LSM9DS1_AG, CTRL_REG2_G, 0x00);
	...
	tempRegValue = 0;
	I2cWriteByte(LSM9DS1_AG, CTRL_REG4, 0b111000);

	// ORIENT_CFG_G (Default value: 0x00)
	// [0][0][SignX_G][SignY_G][SignZ_G][Orient_2][Orient_1][Orient_0]
	// SignX_G - Pitch axis (X) angular rate sign (0: positive, 1: negative)
	// Orient [2:0] - Directional user orientation selection
	I2cWriteByte(LSM9DS1_AG, ORIENT_CFG_G, 0);
}
void LSM_9DS1::MagInit(int scale)
{
	...
	I2cWriteByte(LSM9DS1_M, CTRL_REG1_M, tempRegValue);
	...
	I2cWriteByte(LSM9DS1_M, CTRL_REG2_M, tempRegValue);
	...
	//  10,11: Power-down
	I2cWriteByte(LSM9DS1_M, CTRL_REG3_M, 0); // Continuous conversion mode
	...
	I2cWriteByte(LSM9DS1_M, CTRL_REG4_M, 0b1000);

	// CTRL_REG5_M (Default value: 0x00)
	// [0][BDU][0][0][0][0][0][0]
	// BDU - Block data update for magnetic data
	//	0:continuous, 1:not updated until MSB/LSB are read
	I2cWriteByte(LSM9DS1_M, CTRL_REG5_M, 0);
}
...
bool LSM_9DS1::Initialize(int AccelScale, int GyroScale, int MagnetScale)
{
	...
	//=====接続確認=====
	uint8_t mTest = I2cReadByte(LSM9DS1_M, WHO_AM_I_M);
	uint8_t agTest = I2cReadByte(LSM9DS1_AG, WHO_AM_I_XG);
...
{
	uint8_t status = I2cReadByte(LSM9DS1_AG, STATUS_REG_1);
	if (status & 0b01)
	{
		uint8_t temp[6];
		I2cReadBytes(LSM9DS1_AG, OUT_X_L_XL, temp, 6);
...
bool LSM_9DS1::ReadGyr(float *x, float *y, float *z)
{
	...
	{
		uint8_t temp[6];
		I2cReadBytes(LSM9DS1_AG, OUT_X_L_G, temp, 6);
...
{
	uint8_t status = I2cReadByte(LSM9DS1_M, STATUS_REG_1);
	if (status & 1)
	{
		uint8_t temp[6];
		I2cReadBytes(LSM9DS1_M, OUT_X_L_M, temp, 6);
...
int LSM_9DS1::availableFIFO()
{
	...
	uint8_t status = I2cReadByte(LSM9DS1_AG, FIFO_SRC);
